  ...
  return (
    ...
    >
      <Switch>
        ...
        <LimitRoute exact path="/main/tables" component={Tables} fn={partUser} />
        <LimitRoute exact path="/main/forms" component={Forms} fn={halfUser} />
        <LimitRoute exact path="/main/editor" component={Editor} fn={halfUser} />
        <LimitRoute exact path="/main/tabs" component={Tabs} fn={halfUser} />
        <LimitRoute exact path="/main/upload" component={Upload} fn={oneUser} />
        <LimitRoute exact path="/main/charts" component={Charts} fn={halfUser} />
        <LimitRoute exact path="/main/i18n" component={Locale} fn={partUser} />
        <LimitRoute exact path="/main/markdown" component={Markdown} fn={oneUser} />
