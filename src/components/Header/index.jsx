 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-26 17:02:46
 * @Description:侧边路由导航
 */
...
class SiderRouter extends Component {
  ...
  render() {
    const { collapsed } = this.props.headerStore
    return (
      <div className='header'>
        ...
        <div className='headerRight'>
          <div className='headerUserCon'>
            ...
            {/* 用户头像 */}
            <Avatar className='userAvator' src={require('../../assets/img/img.jpg')} />
            {/* 用户名下拉菜单 */}
            <Dropdown
              className='userName'
              trigger={['click']}
              overlay={
                <Menu onClick={this.handleDropdown}>
                  ...
                  <Menu.Item key='0' className='dropItemLink'>
                    <UploadOutlined className='mgr8' />
                    关于作者
                  </Menu.Item>
                  <Menu.Item key='1' className='dropItemLink'>
                    <VideoCameraOutlined className='mgr8' />
                    项目仓库
                  </Menu.Item>
                  <Menu.Divider />
